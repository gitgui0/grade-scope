...
const Home = () => {
  return (
    <div className="wrapper px-10 py-40 md:px-15 lg:px-20 xl:px-40 h-full flex flex-col space-y-24 bg-neutral-50 dark:bg-neutral-950 *:transitions-colors *:duration-300  transition-colors duration-300">
      <div className="hero-section mx-5 mb-10 pb-10 border-b border-neutral-300 dark:border-zinc-800  md:mx-16 lg:mx-26 xl:mx-52 flex flex-col items-center ">
        <h1 className="text-6xl tracking-tight leading-[1.1] text-center text-neutral-900 dark:text-neutral-50">
          Predict Your Final School Grade{" "}
          <span
            className="text-transparent text-6xl font-bold bg-clip-text bg-gradient-to-r dark:from-sky-400 dark:to-blue-600
              from-sky-400 to-purple-600"
          >
            Precisely
          </span>
        </h1>
        <p className="font-[450] text-2xl text-center mt-14 text-gray-700 dark:text-neutral-300">
          Get a fast and accurate estimate of your final school grade — powered
          by real academic and behavioral data.
        </p>

        <p className=" italic font text-lg text-center mt-8 mb-14 text-zinc-500 dark:text-neutral-400 dark:text-opacity-80">
          Built by students, for students.
        </p>
        <div className="buttons mt-4 px-4 w-full flex items-center justify-center gap-6">
          <Link to="/predict">
            <button
              className="select-none group py-6 px-8 rounded-[2.5em]  bg-gradient-to-r  
          ...
          <a
            href="#how"
            className="select-none text-center py-6 px-8 rounded-[2.5em] bg-neutral-100 border border-opacity-60  border-neutral-300  outline-0 outline-blue-700 hover:outline-2 hover:shadow-sm
            hover:scale-105 
      ...
      <div
        id="how"
        className="how pt-10 sm:mx-2 md:mx-8 lg:mx-12 xl:mx-24 flex flex-col justify-center space-y-10"
      >
        <div className="how-start">
          <h1 className="text-4xl text-left tracking-tight  md:text-5xl font-bold text-neutral-900 pl-2 dark:text-neutral-50">
        ...
        >
          ...
          <div className="how-step1 xl:my-0 gap-4 bg-white dark:bg-neutral-900 bg-opacity-40 xl:p-7 p-5 rounded-xl border border-neutral-200 dark:border-neutral-700 shadow-sm hover:shadow-md transition-shadow ">
            <h1 className="mb-10 font-bold text-3xl text-neutral-900 dark:text-neutral-50">
              <span
                className="select-none inline-flex justify-center
                 items-center bg-gradient-to-r dark:from-sky-700 dark:to-blue-900
              from-sky-300 to-purple-400 text-white rounded-full m-0  w-16 h-16 text-center mr-4"
              >
                <p className="m-0 p-0 font-bold">1</p>
              </span>
              First Step
            </h1>
            <p className=" text-lg text-neutral-700 dark:text-neutral-100 mt-2">
      ...
      <div className="why my-20 mx-4 md:mx-8 lg:mx-16 xl:mx-24 space-y-10">
        <div className="why-start">
          <h2 className="text-4xl md:text-5xl font-bold text-neutral-900 dark:text-neutral-50">
            Why use it?
          </h2>

          <ul className="grid grid-cols-1 lg:grid-cols-2 gap-3 mt-10">
            {[
              "Fast and anonymous",
              ...
              <li
                key={i}
                className={
                  `flex items-center gap-4 bg-white dark:bg-neutral-900 bg-opacity-40 p-5 rounded-xl border border-neutral-200 dark:border-neutral-700 shadow-sm hover:shadow-md transition-shadow last-child-gradient-border` +
                  (i === arr.length - 1 ? " list-item" : "")
                }
              >
                <div className="text-blue-600 dark:text-blue-400 text-2xl leading-none select-none">
                  •
                </div>
      ...
      <div className="about mx-4 md:mx-8 lg:mx-16 xl:mx-24 space-y-7">
        ...
        <p className="text-xl dark:text-neutral-50">
      ...
      <div className="cta  mx-4 md:mx-8 lg:mx-16 xl:mx-24 space-y-10">
        <h2 className="text-4xl mb-10 md:text-5xl font-bold text-neutral-900 dark:text-neutral-50">
